...
//出口参数:无
//**********************************************************************
void Time_Disp_Pro(void)
{
    Set_Chr_Color(COL_WHITE,COL_DEEPGRAY);
    Set_ASC_Lib(Arial22_Font);
   
    Put_Data(240,       180, "%02d", local_time.RTC_Hour);
	 //Put_Char(450+4*15+3,150, 0x2d);
    Put_Data(345,       180, "%02d",local_time.RTC_Min);
	 //Put_Char(640+7*15+3,150, 0x2d);
	Put_Data(445,       180, "%02d",local_time.RTC_Sec); 
...
void  TimeCfg_Oper_Interface(sint32 cur_menu_op)
{
    ...
    Put_Button_Bar(510,130,510+90, 130+50,3,COL_THINBLUE);//OK
    Put_Button_Bar(510,205,510+90, 205+50,3,COL_THINBLUE);//SWITCH
    Set_Chr_Color(COL_BLACK,COL_THINBLUE);
    Put_Line_Str(Language_Pos(535, 540-15),  145,Language_Str("取消","CANCEL"));
    Put_Line_Str(Language_Pos(535, 545), 225,Language_Str("确定","OK"));
