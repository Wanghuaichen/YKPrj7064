...
********************************************************************************************************/
                         /*TDC-GP1 控制寄存器配置*/
#define ConReg0            (*((volatile  unsigned char *) 0x82000000))
#define ConReg1            (*((volatile  unsigned char *) 0x82000000+0x2))
#define ConReg2            (*((volatile  unsigned char *) 0x82000000+0x4))
#define ConReg3            (*((volatile  unsigned char *) 0x82000000+0x6))
#define ConReg4            (*((volatile  unsigned char *) 0x82000000+0x8))
#define ConReg5            (*((volatile  unsigned char *) 0x82000000+0xA))
#define ConReg6            (*((volatile  unsigned char *) 0x82000000+0xC))
#define ConReg7            (*((volatile  unsigned char *) 0x82000000+0xE))
#define ConReg8            (*((volatile  unsigned char *) 0x82000000+0x10)) 
#define Conreg9            (*((volatile  unsigned char *) 0x82000000+0x12))
#define ConReg10           (*((volatile  unsigned char *) 0x82000000+0x14))
#define ConReg11           (*((volatile  unsigned char *) 0x82000000+0x16))
                        /*TDC-GP1 结果寄存器配置*/
#define ResultReg0         (*((volatile  unsigned char *) 0x82000000))
                        /*TDC-GP1 变量声明*/
                        
extern void Init_GP1 (void);

extern void Read_GP1();

void ReadResultReg(); //读出结果寄存器0的数数//
